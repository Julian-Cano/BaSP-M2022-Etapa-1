...
var str11 = str10.substring(0,1).toUpperCase() + str10.substring(1);
console.log(str11);
...
var str15 = str14.substring(0,1).toUpperCase() + str14.substring(1,spaceIndex+1) + str14.substring(spaceIndex+1,
    spaceIndex+2).toUpperCase() + str14.substring(spaceIndex+2);
console.log(str15);